...
| :--- | :--- | :--- | :--- |
| **Smaran Patient App (Tracker)** | Patient companion with 4 brain exercise games, clinical CPS calculation, and background GPS beacon | [Download Patient APK (Catbox)](https://files.catbox.moe/85cm57.apk) | [Smaran-Patient-App.apk](release/Smaran-Patient-App.apk) |
| **Smaran Caregiver App (Guardian)** | Real-time OpenStreetMap radar, safe zone geofencing, live clinical CPS dashboard, and game session logs | [Download Caregiver APK (Catbox)](https://files.catbox.moe/p767fp.apk) | [Smaran-Caregiver-App.apk](release/Smaran-Caregiver-App.apk) |
